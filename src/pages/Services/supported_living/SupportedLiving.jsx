						...
						<div className="supported-living-card">
							...
							<ul>
								<li>
									...
									supported living services that give people
									choice, respect, independence, and quality
									of life. We believe people have the right to
									live the life they choose for themselves in
									their own homes, with their own tenancies.
								</li>
								<li>
									We ensure that people feel safe in their
									environment, people get the right support
									that will enable them to fulfil life
									aspirations and successfully live within the
									community.
								</li>
								<li>
								...
								<li>
									The Support we provide is person-centered
									and tailored to meet individual’s unique
