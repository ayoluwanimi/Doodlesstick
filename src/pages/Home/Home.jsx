  ...
  useEffect(() => {
    ...
    document.querySelectorAll(".training-quick-view").forEach((quickView) => {
      quickView.addEventListener("click", () => {
        ...
        const index = quickView.closest(".training-slide-content").dataset
          .index;
        ...
        const formattedPrice = parseFloat(item.price.replace("$", "")).toFixed(
          2
        );
        ...
        quickViewAddToCart.removeEventListener("click", addToCartHandler);
        quickViewAddToCart.addEventListener("click", addToCartHandler);
    ...
    document.querySelectorAll(".expectations-section").forEach((section) => {
    ...
    <section>
      ...
      <div class="booking-section">
        ...
        <p class="booking-description">
          Unlock personalized assistance and exclusive insights by booking your
          session with us today - your tailored experience awaits!
        </p>
          ...
          <div class="training-slider-container">
            <div class="training-slideshow-wrapper">
              <div class="training-slideshow-container">
                <Slider className="training-slide" {...trainingSettings}>
                  {trainingSlidesData.map((data, index) => (
                    <div className="px-3">
                      ...
                      >
                        ...
                        />
                        <div className="training-quick-view">Quick View</div>
                      </div>
      ...
      <div id="quick-view-modal" class="quick-view-modal">
        <div class="quick-view-content">
          ...
          <div class="quick-view-right">
            ...
            <a href="#" id="quick-view-add-to-cart" class="add-to-cart-button">
              Add to Cart
            </a>
          </div>
        </div>
      ...
      <div class="expectations-section">
        ...
        <div class="expectations-container">
          <div class="expectation-box">
            <div class="expectation-icon" style={{ marginRight: "8px" }}>
              <svg
            ...
            <div class="expectation-text">
              ...
              <p class="expectation-light-text">Utmost Respect & Reverence</p>
            </div>
          </div>
          <div class="expectation-box">
            ...
            <div class="expectation-text">
              <h3 class="expectation-percentage">100%</h3>
              <p class="expectation-light-text">We Always Put Quality First</p>
            </div>
          </div>
          <div class="expectation-box">
            <div class="expectation-icon" style={{ marginRight: "15px" }}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 496 512"
                style={{ width: "53px", height: "53px" }}
        ...
        <div class="expectations-single-box">
          ...
          <div class="expectation-text">
            ...
            <p class="expectation-light-text">Always Happy Customers</p>
          </div>
        </div>
      </div>
        ...
        <div class="offers-container">
          <div class="offer-box">
            ...
            <div class="offer-text">
              ...
              <p class="offer-description">
                Experience the convenience of virtual assistance tailored to
                your needs – book your session now for expert guidance and
          ...
          <div class="offer-box">
            ...
            <div class="offer-text">
              ...
              <p class="offer-description">
                Elevate your skills and knowledge through our specialized
                training sessions. Book your training session today and embark
                on a journey of continuous learning and professional
                development.
              </p>
            </div>
          </div>
          <div class="offer-box">
            ...
            <div class="offer-text">
              ...
              <p class="offer-description">
                Navigate the complexities of healthcare with our specialized
                medical consultancy services. Book a session today to gain
                strategic insights and personalized solutions, ensuring optimal
                outcomes for you
              </p>
            </div>
          </div>
